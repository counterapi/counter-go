...
BASE_PACKAGE_NAME  = github.com/counterapi/counter-go
...
release: build-for-container
	...
	docker tag counter:latest counterapi/counter-go:$(GIT_VERSION)
	docker push counterapi/counter-go:$(GIT_VERSION)
